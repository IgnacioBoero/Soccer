...
def _objective(trial: optuna.Trial, train_paths: List[Path], val_paths: List[Path], epochs: int, target_type: str, device= 'cuda:0'):
    # hyper‑parameters
...
def run_optuna(shards_dir: Path, trials: int, epochs: int, target_type: str, device = 'cuda:0'):
